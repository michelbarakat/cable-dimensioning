    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="single-current" className="text-gray-300 font-medium">
            Current in A
          </label>
          <input
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="single-length" className="text-gray-300 font-medium">
            Length in meters
          </label>
          <input
            className="bg-gray-900 border-2 border-gray-700 rounded-lg p-3 text-white focus:border-blue-500 focus:outline-none transition-colors"
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="single-resistivity" className="text-gray-300 font-medium">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="single-crossSection" className="text-gray-300 font-medium">
            Cross Section in mm²
          </label>
          <input
            className="bg-gray-900 border-2 border-gray-700 rounded-lg p-3 text-white focus:border-blue-500 focus:outline-none transition-colors"
...
const Single = ({ cableEngine = null }: { cableEngine?: CableEngine | null }) => {
  ...
  const handleCalculate = async () => {
    if (cableEngine) {
      const d = await cableEngine.voltageDropSingle(
        parseNumber(current),
        parseNumber(length),
    ...
    <div className="flex gap-4 items-start">
      <div className="flex-1 min-w-[750px] bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
        <div className="flex items-center gap-4 mb-6">
          <h3 className="text-2xl font-bold flex-1 text-white">Single-Phase Voltage Drop</h3>
