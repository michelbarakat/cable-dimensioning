    ...
    <div className="flex gap-4 items-start">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="cross-section-three-current" className="text-gray-300 font-medium">
            Current (A)
          </label>
          <input
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="cross-section-three-length" className="text-gray-300 font-medium">
            Length (m)
          </label>
          <input
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="cross-section-three-resistivity" className="text-gray-300 font-medium">
            Resistivity (Ω·mm²/m)
          </label>
          <input
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="cross-section-three-maxVoltageDrop" className="text-gray-300 font-medium">
            Max Voltage Drop (V)
          </label>
          <input
